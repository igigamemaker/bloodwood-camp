...
const bossProfiles=[{tex:'bossImported1',name:'Dread Reaper',color:0x38bdf8,size:2.7,baseHp:1000,baseDmg:38,spd:1.45},{tex:'bossImported2',name:'Moss Colossus',color:0x84cc16,size:2.9,baseHp:1250,baseDmg:42,spd:1.15},{tex:'bossImported3',name:'Stonecrusher Ogre',color:0x93c5fd,size:2.85,baseHp:1500,baseDmg:46,spd:1.35},{tex:'bossImported4',name:'Infernal Overlord',color:0xff5a2f,size:3.0,baseHp:1750,baseDmg:50,spd:1.2},{tex:'bossImported5',name:'Plague Bringer',color:0xbef264,size:2.95,baseHp:2500,baseDmg:54,spd:1.1},{tex:'bossImported6',name:'Swamp Behemoth',color:0x86efac,size:3.0,baseHp:2000,baseDmg:58,spd:1.05},{tex:'bossImported7',name:'Magma Elemental',color:0xf97316,size:3.1,baseHp:2250,baseDmg:62,spd:0.95},{tex:'bossImported8',name:'Lich Lord',color:0xa855f7,size:2.85,baseHp:2500,baseDmg:66,spd:1.22},{tex:'bossImported9',name:'Arachnid Queen',color:0xf472b6,size:2.7,baseHp:2750,baseDmg:70,spd:1.25},{tex:'bossImported10',name:'Abyssal Devourer',color:0x22d3ee,size:3.0,baseHp:3500,baseDmg:74,spd:0.9},{tex:'bossImported11',name:'Void Wraith',color:0xa78bfa,size:2.85,baseHp:3000,baseDmg:78,spd:1.25},{tex:'bossImported12',name:'Toxic Horror',color:0x22c55e,size:2.95,baseHp:3250,baseDmg:82,spd:1.05},{tex:'bossImported13',name:'Bone Harvester',color:0xe5e7eb,size:2.9,baseHp:3500,baseDmg:86,spd:1.0},{tex:'bossImported14',name:'Pumpkin Fiend',color:0xf97316,size:2.85,baseHp:3750,baseDmg:90,spd:1.05},{tex:'bossImported15',name:'Fallen Vampire',color:0xef4444,size:3.0,baseHp:4500,baseDmg:94,spd:1.15},{tex:'bossImported16',name:'Fire Titan',color:0xf97316,size:3.25,baseHp:4000,baseDmg:98,spd:0.95},{tex:'bossImported17',name:'Winged Death',color:0x86efac,size:3.05,baseHp:4250,baseDmg:102,spd:1.1},{tex:'bossImported18',name:'Forest Guardian',color:0x22c55e,size:3.0,baseHp:4500,baseDmg:106,spd:1.05},{tex:'bossImported19',name:'Shadow Dragon',color:0xa855f7,size:3.4,baseHp:4750,baseDmg:110,spd:1.0},{tex:'bossImported20',name:'Ironclad Behemoth',color:0xcbd5e1,size:3.35,baseHp:5500,baseDmg:114,spd:0.85},{tex:'bossImported21',name:'Deep Sea Tyrant',color:0x22d3ee,size:3.2,baseHp:5000,baseDmg:118,spd:0.95},{tex:'bossImported22',name:'Goblin Warlord',color:0xa3e635,size:3.0,baseHp:5250,baseDmg:122,spd:1.2},{tex:'bossImported23',name:'Crystal Golem',color:0x38bdf8,size:3.25,baseHp:5500,baseDmg:126,spd:0.9},{tex:'bossImported24',name:'Necrotic Abomination',color:0x84cc16,size:3.4,baseHp:5750,baseDmg:130,spd:0.82},{tex:'bossImported25',name:'Final Doombringer',color:0xd946ef,size:4.15,baseHp:10000,baseDmg:134,spd:1.08}];
...
const finalBossProfile={tex:'bossImported25',name:'Final Doombringer',color:0xd946ef,size:4.35,baseHp:10000,baseDmg:205,spd:1.08,fireCd:2.25,fireSpeed:5.1,fireDmg:104};
